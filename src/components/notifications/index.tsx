...
export const Notifications = () => {
    ...
    return (
        <Menu as="div" className="relative">
            <Menu.Button
                className="inline-flex items-center justify-center mt-1 text-sm font-medium text-center text-gray-500 hover:text-gray-700 focus:outline-none dark:hover:text-gray-200 dark:text-gray-400">
                <span className="sr-only">Open Notification menu</span>
                <HiBell className="h-6 w-6" aria-hidden="true"/>
                {hasNotifications && (<div className="relative flex">
                    <div
            ...
            >
                <Menu.Items
                    className="absolute right-0 z-20 w-[384px] mt-2 origin-top-right dark:bg-gray-800 dark:divide-gray-700 bg-white divide-y divide-gray-100 rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                    <Menu.Item>
                        {() => (
                            <div
                            ...
                            <div className="divide-y divide-gray-100 dark:divide-gray-700">
                                ...
                                >
                                    <div className="flex-shrink-0">
                                        ...
                                        />
                                        <div
                                            className="absolute flex items-center justify-center w-5 h-5 ml-6 -mt-5 bg-gray-900 border border-white rounded-full dark:border-gray-800">
                                            <svg
                                                className="w-3 h-3 text-white"
                                                aria-hidden="true"
                                                fill="currentColor"
                                ...
                                >
                                    <div className="flex-shrink-0">
                                        ...
                                        />
                                        <div
                                            className="absolute flex items-center justify-center w-5 h-5 ml-6 -mt-5 bg-red-600 border border-white rounded-full dark:border-gray-800">
                                            <svg
                                                className="w-3 h-3 text-white"
                                                aria-hidden="true"
                                                fill="currentColor"
                        ...
                        141 others
                                ...
                                >
                                    <div className="flex-shrink-0">
                                        ...
                                        />
                                        <div
                                            className="absolute flex items-center justify-center w-5 h-5 ml-6 -mt-5 bg-green-400 border border-white rounded-full dark:border-gray-800">
                                            <svg
                                                className="w-3 h-3 text-white"
                                                aria-hidden="true"
                                                fill="currentColor"
                        ...
                        Leslie Livingston
                                ...
                                >
                                    <div className="flex-shrink-0">
                                        ...
                                        />
                                        <div
                                            className="absolute flex items-center justify-center w-5 h-5 ml-6 -mt-5 bg-purple-500 border border-white rounded-full dark:border-gray-800">
                                            <svg
                                                className="w-3 h-3 text-white"
                                                aria-hidden="true"
                                                fill="currentColor"
