...
const LineGraph: React.FC<any> = () => {
    ...
    return (
        <ResponsiveContainer height={400} width={'100%'}>
            ...
            >
                <CartesianGrid strokeDasharray="3 3" stroke={dark ? 'rgba(241,241,241,0.05)':'rgba(193,193,193,0.1)'}/>
                <XAxis dataKey="name" tick={renderCustomAxisTick} stroke={dark ? '#f6f6f6':'#0e0e0e'}/>
                <YAxis stroke={dark ? '#f6f6f6':'#0e0e0e'}/>
                <Tooltip/>
                <Legend/>
                <Line type="monotone" dataKey="uv" stroke={dark ? '#009dff':'#0065fd'}/>
            </LineChart>
        </ResponsiveContainer>
    );
}
